...
<body style="background-color: #66FFFF">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnReturntoMM" runat="server" height="26px" OnClick="btnReturntoMM_Click" style="z-index: 1; left: 477px; top: 509px; position: absolute; width: 143px" Text="Return to Main Menu" />
        <p>
        ...
        <p>
            <asp:Label ID="lblError" runat="server" Font-Bold="True" ForeColor="Red" style="z-index: 1; left: 512px; top: 50px; position: absolute"></asp:Label>
            <asp:Button ID="btnStats" runat="server" height="26px" OnClick="btnStats_Click" style="z-index: 1; left: 332px; top: 510px; position: absolute; width: 113px" Text="Check Statistics" />
        </p>
        <p>
